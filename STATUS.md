...
**Текущая задача:** P1 — Release 2 (Operate) — **ВСЕ DONE**
**Следующий шаг:** P2 (если нужен)
...
| 8 | **8.1–8.2** | Кабинет покупателя + история заказов | ✅ готово |
| 9 | **9.1** | Управление остатками в UI | ✅ готово |
| 10 | **12.1** | Базовая аналитика (продажи по дням, средний чек) | ✅ готово |
| 11 | **10.1** | Public API для интеграторов | ✅ готово |
| 12 | **13.1** | Роли: owner / admin / operator / marketer | ✅ готово |
