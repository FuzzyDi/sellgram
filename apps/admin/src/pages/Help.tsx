  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        qUz: 'Kirim hujjatining statuslari qanday?',
        aRu: 'DRAFT → ORDERED → IN_TRANSIT → RECEIVED, либо CANCELLED с любого промежуточного этапа. При RECEIVED — остатки по всем позициям обновляются автоматически.',
        aUz: "DRAFT → ORDERED → IN_TRANSIT → RECEIVED, yoki istalgan oraliq bosqichdan CANCELLED. RECEIVED da — barcha pozitsiyalar bo'yicha qoldiqlar avtomatik yangilanadi.",
      },
      {
        qRu: 'Как работает оплата «в долг»?',
        qUz: "«Qarzga» to'lov qanday ishlaydi?",
        aRu: 'При создании документа выберите способ оплаты: наличные, безналичный или в долг. Для «в долг» нужно выбрать поставщика из списка контрагентов — при приёмке товара сумма автоматически ляжет на его баланс. Платежи и корректировки долга записываются на странице поставщика во вкладке «Платёж / Корректировка».',
        aUz: "Hujjat yaratishda to'lov usulini tanlang: naqd, naqd emas yoki qarzga. «Qarzga» uchun kontragentlar ro'yxatidan yetkazib beruvchini tanlash kerak — tovar qabul qilinganda summa avtomatik uning balansiga tushadi. To'lovlar va qarz tuzatishlari yetkazib beruvchi sahifasidagi «To'lov / Tuzatish» bo'limida qayd etiladi.",
      },
    ],
  },
  {
